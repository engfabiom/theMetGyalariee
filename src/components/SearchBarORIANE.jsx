  ...
  return (
    <div className='search-bar__container'>
      ...
      <div className='search-bar__categories-box' onClick={toggleMenu}>
        ...
        <svg
          className='search-bar__categories-arrowdown-svg'
          width='13'
          height='13'
          viewBox='0 0 13 13'
          xmlns='http://www.w3.org/2000/svg'
