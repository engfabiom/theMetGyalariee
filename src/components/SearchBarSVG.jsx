...
function IconMagnifyingGlass () { 
    return(
        <svg className="search-bar-svg__magnifying-glass" width="43" height="43" viewBox="0 0 43 43" xmlns="http://www.w3.org/2000/svg">
    ...
    return (
        ...
        >
            <g clipPath="url(#clip0_46_796)">
                <path 
                    style={{ fill: filtersIsHovered ? "var(--color-text--hover-primary)" : "var(--color-text-primary)" }}
